		    ...
		    <div class="container-fluid">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Welcome to RixetBD Dashboard</li>
                                    </ol>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h6 class="mb-0"><img src="public/assets/images/users/user-3.jpg" alt="" class="thumb-sm rounded-circle mr-2"> James Athey</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <ul class="conversation-list slimscroll" style="max-height: 400px;">
                                                <li class="clearfix">
                                                    <div class="chat-avatar">
                                                        <img src="public/assets/images/users/user-2.jpg" alt="male">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="public/assets/images/users/user-3.jpg" alt="Female">
                                                ...
                                                <li class="clearfix odd">
                                                    <div class="chat-avatar">
                                                        <img src="public/assets/images/users/user-3.jpg" alt="male">
                                                ...
                                                <li class="clearfix odd">
                                                    ...
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                            ...
                                                            <img src="public/assets/images/small/img-1.jpg" alt="" height="48px" class="rounded mr-2">
                                                            <img src="public/assets/images/small/img-2.jpg" alt="" height="48px" class="rounded">
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
